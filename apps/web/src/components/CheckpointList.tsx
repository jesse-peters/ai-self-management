        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              <h4 className="font-semibold text-gray-900 mb-1">{checkpoint.label}</h4>
              <p className="text-sm text-gray-600 mb-2">{checkpoint.summary}</p>
              {checkpoint.repo_ref && (
              ...
              {checkpoint.resume_instructions && (
                <details className="mt-2">
                  ...
                  <p className="mt-2 text-xs text-gray-700 bg-gray-50 p-2 rounded whitespace-pre-wrap">
                    {checkpoint.resume_instructions}
                  </p>
                </details>
              )}
            ...
            <div className="text-right">
              <span className="text-xs text-gray-400">{formatDate(checkpoint.created_at)}</span>
            </div>
          </div>
        </div>
      ))}
